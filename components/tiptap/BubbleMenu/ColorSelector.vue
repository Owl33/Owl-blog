...
<template>
  <Popover>
    <div class="relative">
      <PopoverButton
        class="flex items-center h-full gap-1 p-3 text-sm font-medium text-stone-600 hover:bg-stone-100 active:bg-stone-200 focus:outline-none"
      >
        <span
